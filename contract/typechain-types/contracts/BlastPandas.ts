...
export interface BlastPandasInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface BlastPandas extends BaseContract {
  connect(runner?: ContractRunner | null): BlastPandas;
  waitForDeployment(): Promise<this>;

  interface: BlastPandasInterface;

...
export interface CryptoPandiansInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export namespace CreatePandaEvent {
...
export interface CryptoPandians extends BaseContract {
  connect(runner?: ContractRunner | null): CryptoPandians;
  waitForDeployment(): Promise<this>;

  interface: CryptoPandiansInterface;
  ...
  getEvent(
    ...
    CreatePandaEvent.InputTuple,
    CreatePandaEvent.OutputTuple,
    CreatePandaEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "CreatePanda(uint256)": TypedContractEvent<
      CreatePandaEvent.InputTuple,
      CreatePandaEvent.OutputTuple,
      CreatePandaEvent.OutputObject
    >;
    CreatePanda: TypedContractEvent<
      CreatePandaEvent.InputTuple,
      CreatePandaEvent.OutputTuple,
      CreatePandaEvent.OutputObject
    >;
